    ...
    <div className="flex min-h-screen bg-surface-container">
      ...
      <div className="md:hidden fixed top-0 left-0 right-0 bg-surface-container-high border-b z-30 p-3">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="rounded-lg border border-outline-variant/25 p-2 text-on-surface-variant hover:bg-surface-variant"
          >
            <MenuIcon size={18} />
          </button>
        </div>
      ...
      {mobileNavOpen && (
        <div className="md:hidden fixed inset-0 z-40">
          ...
          />
          <aside className="absolute right-0 top-0 h-full w-72 max-w-[85vw] bg-surface-container-high border-l shadow-xl flex flex-col">
            <div className="p-4 border-b flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <h1 className="text-lg font-headline font-bold text-primary">POLLÓN</h1>
              </div>
              <button
                onClick={() => setMobileNavOpen(false)}
